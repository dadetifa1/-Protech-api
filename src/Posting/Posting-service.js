...
const PostingService = {
  getPostings(db) {
    ...
    .innerJoin('protech_sales_commission_hist', 'protech_sales_commission_hist.posting_id', 'protech_posting.id')
    .innerJoin('protech_saleperson','protech_saleperson.id' ,  'protech_sales_commission_hist.sales_person_id')
    .select(
      'protech_posting.id',
  ...
  updateSaleCommission(db, updatedSalesCommission){
    return SalesCommisionService.updateSaleCommissionByPostingID(db, updatedSalesCommission.posting_id, updatedSalesCommission)
  }
